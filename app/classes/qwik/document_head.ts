...
interface LinkElement extends HeadElementBase<"link", {
  rel?: string;
  href?: string;
  as?: string;
  type?: string;
...
interface MetaElement extends HeadElementBase<"meta", {
  name?: string;
  content?: string;
  charset?: string;
  httpEquiv?: string;
...
interface ScriptElement extends HeadElementBase<"script", {
  src?: string;
  async?: boolean;
  defer?: boolean;
  type?: string;
