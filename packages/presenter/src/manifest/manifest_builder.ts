...
import { Presenter } from '../class/index.js'
import { classNameString } from '../utils/utils.js'
import { JsonManifest, MethodMetadata, ParameterMetadata, PresenterMetadata } from './types.js'

export class PresenterManifestBuilder {
  static presenterDir = app.httpControllersPath()
  static config = app.config.get<AtoposConfig>('atopos.config')
